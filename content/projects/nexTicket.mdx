---
title: TexTicket
description: During my tenure at the Greenfox Academy, I was privileged to be part of the nextGen team, where we collaboratively developed NexTicket, a ticketing solution akin to industry giants like Ticketmaster. The project aimed to revolutionize the ticketing experience, catering to diverse events ranging from concerts to sports events.
date: "2023-09-15"
...
[![](https://github.com/AttilaTap/aureus-foxticket-nextgen-nextjs/blob/testing/frontend/public/img/NexTicket.png)](https://planetfall.io)
